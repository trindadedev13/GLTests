...
public class HIDDeviceManager {
  ...
  private void connectHIDDeviceUSB(UsbDevice usbDevice) {
    synchronized (this) {
      ...
      for (int interface_index = 0;
          interface_index < usbDevice.getInterfaceCount();
          interface_index++) {
  ...
  private void initializeBluetooth() {
    ...
    if (Build.VERSION.SDK_INT <= 30 /* Android 11.0 (R) */
        && mContext
                .getPackageManager()
                .checkPermission(android.Manifest.permission.BLUETOOTH, mContext.getPackageName())
            != PackageManager.PERMISSION_GRANTED) {
  ...
  native void HIDDeviceConnected(
      int deviceID,
      String identifier,
      int vendorId,
      int productId,

...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
  ...
  */
  ...
  public static void initialize() {
    ...
    // here Otherwise, when exiting the app and returning to it, these variables *keep* their pre
    // exit values
    mSingleton = null;
    mSurface = null;
    mTextEdit = null;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (!mBrokenLibraries) {
      String expected_version = String.valueOf(SDL_MAJOR_VERSION) + "."
              + String.valueOf(SDL_MINOR_VERSION) + "." + String.valueOf(SDL_MICRO_VERSION);
      String version = nativeGetVersion();
      if (!version.equals(expected_version)) {
        mBrokenLibraries = true;
        errorMsgBrokenLib = "SDL C/Java version mismatch (expected " + expected_version + ", got "
                + version + ")";
      }
    }
    ...
    if (mBrokenLibraries) {
      ...
      dlgAlert.setMessage("An error occurred while trying to start the application. Please try "
              + "again and/or reinstall." + System.getProperty("line.separator")
              + System.getProperty("line.separator") + "Error: " + errorMsgBrokenLib);
  ...
  public static native void nativeSetScreenResolution(int surfaceWidth, int surfaceHeight,
          int deviceWidth, int deviceHeight, float density, float rate);
  ...
  public static void initTouch() {
    ...
    for (int id : ids) {
      ...
      /* Allow SOURCE_TOUCHSCREEN and also Virtual InputDevices because they can send TOUCHSCREEN
       * events */
      if (device != null
  ...
  public int messageboxShowMessageBox(final int flags, final String title, final String message,
          final int[] buttonFlags, final int[] buttonIds, final String[] buttonTexts,
          final int[] colors) {
  ...
  public static String formatLocale(Locale locale) {
    ...
    if (locale.getLanguage() == "in") {
      // Indonesian is "id" according to ISO 639.2, but on Android is "in" because of Java backwards
      // compatibility
      lang = "id";

...
// Basic GamePadView for Brut Game.
// @see {interface#GamePadListener} at file end.
// Author: Aquiles Trindade (trindadedev).
public final class BrutGamePadView extends View {
  ...
  public BrutGamePadView(final Context context) {
    super(context);
    init(context, null, -1, -1);
  }

  public BrutGamePadView(final Context context, AttributeSet attrSet) {
    super(context, attrSet);
    init(context, attrSet, -1, -1);
  }

  public BrutGamePadView(final Context context, AttributeSet attrSet, int styleResId) {

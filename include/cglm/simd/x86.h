...
union {
  int i;
  float f;
} static GLMM_NEGZEROf_TU = {.i = (int)0x80000000};
...
#if defined(__SSE2__)
#define GLMM__SIGNMASKf(X, Y, Z, W) _mm_castsi128_ps(_mm_set_epi32(X, Y, Z, W))
/* _mm_set_ps(X, Y, Z, W); */
#else
...
#define glmm_float32x4_SIGNMASK_PNPN \
  GLMM__SIGNMASKf(GLMM_POSZEROf, GLMM_NEGZEROf, GLMM_POSZEROf, GLMM_NEGZEROf)
#define glmm_float32x4_SIGNMASK_NPNP \
  GLMM__SIGNMASKf(GLMM_NEGZEROf, GLMM_POSZEROf, GLMM_NEGZEROf, GLMM_POSZEROf)
#define glmm_float32x4_SIGNMASK_NPPN \
  GLMM__SIGNMASKf(GLMM_NEGZEROf, GLMM_POSZEROf, GLMM_POSZEROf, GLMM_NEGZEROf)

/* fasth math prevents -0.0f to work */
#if defined(__SSE2__)
#define glmm_float32x4_SIGNMASK_NEG \
  _mm_castsi128_ps(_mm_set1_epi32(GLMM_NEGZEROf)) /* _mm_set1_ps(-0.0f) */
#else
#define glmm_float32x4_SIGNMASK_NEG glmm_set1(GLMM_NEGZEROf)
#endif

#define glmm_float32x8_SIGNMASK_NEG \
  _mm256_castsi256_ps(_mm256_set1_epi32(GLMM_NEGZEROf))

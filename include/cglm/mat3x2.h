 ...
 */
CGLM_INLINE
void glm_mat3x2_copy(mat3x2 src, mat3x2 dest) {
 ...
 */
CGLM_INLINE
void glm_mat3x2_make(const float* __restrict src, mat3x2 dest) {
  dest[0][0] = src[0];
  dest[0][1] = src[1];
 ...
 */
CGLM_INLINE
void glm_mat3x2_mulv(mat3x2 m, vec3 v, vec2 dest) {
 ...
 */
CGLM_INLINE
void glm_mat3x2_transpose(mat3x2 src, mat2x3 dest) {
  dest[0][0] = src[0][0];
  dest[0][1] = src[1][0];
  dest[0][2] = src[2][0];
  dest[1][0] = src[0][1];
 ...
 */
CGLM_INLINE
void glm_mat3x2_scale(mat3x2 m, float s) {
  m[0][0] *= s;
  m[0][1] *= s;
  m[1][0] *= s;
  m[1][1] *= s;

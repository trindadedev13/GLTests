...
CGLM_EXPORT
void glmc_frustum_rh_zo(float left,
                        float right,
                        float bottom,
                        float top,
                        float nearZ,
...
CGLM_EXPORT
void glmc_perspective_rh_zo(float fovy,
                            float aspect,
                            float nearVal,
                            float farVal,
                            mat4 dest);
...
CGLM_EXPORT
void glmc_persp_decomp_rh_zo(mat4 proj,
...
CGLM_EXPORT
void glmc_persp_decomp_x_rh_zo(mat4 proj,
                               float* __restrict left,
                               float* __restrict right);

CGLM_EXPORT
void glmc_persp_decomp_y_rh_zo(mat4 proj,
                               float* __restrict top,
                               float* __restrict bottom);

CGLM_EXPORT
void glmc_persp_decomp_z_rh_zo(mat4 proj,
                               float* __restrict nearZ,
                               float* __restrict farZ);

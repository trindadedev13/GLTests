...
/* WARN: dont use concant helpers outside cglm headers, because they may be
 * changed */

#define CGLM_MACRO_CONCAT_HELPER(A, B, C, D, E, ...) A##B##C##D##E##__VA_ARGS__
#define CGLM_MACRO_CONCAT(A, B, C, D, E, ...) \
  CGLM_MACRO_CONCAT_HELPER(A, B, C, D, E, __VA_ARGS__)
...
#define CGLM_STRUCTAPI(A, ...)                                           \
  CGLM_MACRO_CONCAT(CGLM_STRUCT_API_NS, CGLM_STRUCT_API_NS_SEPERATOR, A, \
                    CGLM_STRUCT_API_NAME_SUFFIX, _, __VA_ARGS__)

...
/*
 ...
 glms_mat3_trace(mat3s m); CGLM_INLINE versor glms_mat3_quat(mat3s m);
   ...
   CGLM_INLINE mat3s  glms_mat3_textrans(float sx, float sy, float rot, float
 tx, float ty);
 */
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(copy)(mat3s mat) {
  mat3s r;
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(identity)(void) {
  mat3s r;
 ...
 */
CGLM_INLINE
void glms_mat3_(identity_array)(mat3s* __restrict mat, size_t count) {
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(mul)(mat3s m1, mat3s m2) {
  mat3s r;
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(transpose)(mat3s m) {
 ...
 */
CGLM_INLINE
vec3s glms_mat3_(mulv)(mat3s m, vec3s v) {
  vec3s r;
 ...
 */
CGLM_INLINE
versors glms_mat3_(quat)(mat3s m) {
  versors r;
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(scale)(mat3s m, float s) {
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(inv)(mat3s mat) {
  mat3s r;
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(swap_col)(mat3s mat, int col1, int col2) {
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(swap_row)(mat3s mat, int row1, int row2) {
 ...
 */
CGLM_INLINE
float glms_mat3_(rmc)(vec3s r, mat3s m, vec3s c) {
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(make)(const float* __restrict src) {
  mat3s r;
 ...
 */
CGLM_INLINE
mat3s glms_mat3_(textrans)(float sx, float sy, float rot, float tx, float ty) {
  mat3s r;

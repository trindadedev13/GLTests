 ...
 */
CGLM_INLINE
mat2x3s glms_mat2x3_(zero)(void) {
  mat2x3s dest;
 ...
 */
CGLM_INLINE
mat2x3s glms_mat2x3_(make)(const float* __restrict src) {
  mat2x3s dest;
 ...
 */
CGLM_INLINE
mat3s glms_mat2x3_(mul)(mat2x3s m1, mat3x2s m2) {
  mat3s dest;
 ...
 */
CGLM_INLINE
vec3s glms_mat2x3_(mulv)(mat2x3s m, vec2s v) {
  vec3s dest;
 ...
 */
CGLM_INLINE
mat3x2s glms_mat2x3_(transpose)(mat2x3s m) {
  mat3x2s dest;
 ...
 */
CGLM_INLINE
mat2x3s glms_mat2x3_(scale)(mat2x3s m, float s) {

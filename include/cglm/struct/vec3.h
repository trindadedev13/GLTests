 ...
 */
CGLM_INLINE
void glms_vec3_(pack)(vec3s dst[], vec3 src[], size_t len) {
  size_t i;
 ...
 */
CGLM_INLINE
void glms_vec3_(unpack)(vec3 dst[], vec3s src[], size_t len) {
  size_t i;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(add)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(adds)(vec3s a, float s) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(sub)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(subs)(vec3s a, float s) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(mul)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(scale)(vec3s v, float s) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(scale_as)(vec3s v, float s) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(div)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(divs)(vec3s a, float s) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(addadd)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(subadd)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(muladd)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(muladds)(vec3s a, float s, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(maxadd)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(minadd)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(subsub)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(addsub)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(mulsub)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(mulsubs)(vec3s a, float s, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(maxsub)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(minsub)(vec3s a, vec3s b, vec3s dest) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(flipsign)(vec3s v) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(negate)(vec3s v) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(normalize)(vec3s v) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(cross)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(crossn)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
float glms_vec3_(angle)(vec3s a, vec3s b) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(rotate)(vec3s v, float angle, vec3s axis) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(rotate_m4)(mat4s m, vec3s v) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(rotate_m3)(mat3s m, vec3s v) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(proj)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(center)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
float glms_vec3_(distance)(vec3s a, vec3s b) {
 ...
 */
CGLM_INLINE
float glms_vec3_(distance2)(vec3s a, vec3s b) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(maxv)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(minv)(vec3s a, vec3s b) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(ortho)(vec3s v) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(clamp)(vec3s v, float minVal, float maxVal) {
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(lerp)(vec3s from, vec3s to, float t) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(lerpc)(vec3s from, vec3s to, float t) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(mix)(vec3s from, vec3s to, float t) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(mixc)(vec3s from, vec3s to, float t) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(step)(vec3s edge, vec3s x) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(smoothstep_uni)(float edge0, float edge1, vec3s x) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(smoothstep)(vec3s edge0, vec3s edge1, vec3s x) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(smoothinterp)(vec3s from, vec3s to, float t) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(smoothinterpc)(vec3s from, vec3s to, float t) {
  vec3s r;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(swizzle)(vec3s v, int mask) {
  vec3s dest;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(make)(const float* __restrict src) {
  vec3s dest;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(faceforward)(vec3s n, vec3s v, vec3s nref) {
  vec3s dest;
 ...
 */
CGLM_INLINE
vec3s glms_vec3_(reflect)(vec3s v, vec3s n) {
  vec3s dest;
...
/*!
 * @brief computes refraction vector for an incident vector and a surface
 * normal.
 *
 * calculates the refraction vector based on Snell's law. If total internal
 * reflection occurs (angle too great given eta), dest is set to zero and
 * returns false. Otherwise, computes refraction vector, stores it in dest, and
 * returns true.
 *
 * @param[in]  v    normalized incident vector
 * @param[in]  n    normalized normal vector
 * @param[in]  eta  ratio of indices of refraction (incident/transmitted)
 * @param[out] dest refraction vector if refraction occurs; zero vector
 * otherwise
 *
 ...
 */
CGLM_INLINE
bool glms_vec3_(refract)(vec3s v, vec3s n, float eta, vec3s* __restrict dest) {

 ...
 */
CGLM_INLINE
versors glms_euler_xyz_quat_rh(vec3s angles) {
  versors dest;
 ...
 */
CGLM_INLINE
versors glms_euler_xzy_quat_rh(vec3s angles) {
  versors dest;
 ...
 */
CGLM_INLINE
versors glms_euler_yxz_quat_rh(vec3s angles) {
  versors dest;
 ...
 */
CGLM_INLINE
versors glms_euler_yzx_quat_rh(vec3s angles) {
  versors dest;
 ...
 */
CGLM_INLINE
versors glms_euler_zxy_quat_rh(vec3s angles) {
  versors dest;
 ...
 */
CGLM_INLINE
versors glms_euler_zyx_quat_rh(vec3s angles) {
  versors dest;

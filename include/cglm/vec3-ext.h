 ...
 */
CGLM_INLINE
void glm_vec3_floor(vec3 v, vec3 dest) {
  dest[0] = floorf(v[0]);
  dest[1] = floorf(v[1]);
  dest[2] = floorf(v[2]);
}
 ...
 */
CGLM_INLINE
void glm_vec3_mods(vec3 v, float s, vec3 dest) {
  dest[0] = fmodf(v[0], s);
  dest[1] = fmodf(v[1], s);
  dest[2] = fmodf(v[2], s);
}
 ...
 */
CGLM_INLINE
void glm_vec3_steps(float edge, vec3 x, vec3 dest) {
 ...
 */
CGLM_INLINE
void glm_vec3_stepr(vec3 edge, float x, vec3 dest) {

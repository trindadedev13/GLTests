 ...
 */
CGLM_INLINE
void glm_ivec3_addadd(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] += a[0] + b[0];
  dest[1] += a[1] + b[1];
  dest[2] += a[2] + b[2];
}
 ...
 */
CGLM_INLINE
void glm_ivec3_addadds(ivec3 a, int s, ivec3 dest) {
  dest[0] += a[0] + s;
  dest[1] += a[1] + s;
  dest[2] += a[2] + s;
}
 ...
 */
CGLM_INLINE
void glm_ivec3_subadd(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] += a[0] - b[0];
  dest[1] += a[1] - b[1];
  dest[2] += a[2] - b[2];
}
 ...
 */
CGLM_INLINE
void glm_ivec3_subadds(ivec3 a, int s, ivec3 dest) {
  dest[0] += a[0] - s;
  dest[1] += a[1] - s;
  dest[2] += a[2] - s;
}
 ...
 */
CGLM_INLINE
void glm_ivec3_muladd(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] += a[0] * b[0];
  dest[1] += a[1] * b[1];
  dest[2] += a[2] * b[2];
}
 ...
 */
CGLM_INLINE
void glm_ivec3_muladds(ivec3 a, int s, ivec3 dest) {
  dest[0] += a[0] * s;
  dest[1] += a[1] * s;
  dest[2] += a[2] * s;
}
 ...
 */
CGLM_INLINE
void glm_ivec3_maxadd(ivec3 a, ivec3 b, ivec3 dest) {
 ...
 */
CGLM_INLINE
void glm_ivec3_minadd(ivec3 a, ivec3 b, ivec3 dest) {
 ...
 */
CGLM_INLINE
void glm_ivec3_subsub(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] -= a[0] - b[0];
  dest[1] -= a[1] - b[1];
  dest[2] -= a[2] - b[2];
}
 ...
 */
CGLM_INLINE
void glm_ivec3_subsubs(ivec3 a, int s, ivec3 dest) {
  dest[0] -= a[0] - s;
  dest[1] -= a[1] - s;
  dest[2] -= a[2] - s;
}
 ...
 */
CGLM_INLINE
void glm_ivec3_addsub(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] -= a[0] + b[0];
  dest[1] -= a[1] + b[1];
  dest[2] -= a[2] + b[2];
}
 ...
 */
CGLM_INLINE
void glm_ivec3_addsubs(ivec3 a, int s, ivec3 dest) {
  dest[0] -= a[0] + s;
  dest[1] -= a[1] + s;
  dest[2] -= a[2] + s;
}
 ...
 */
CGLM_INLINE
void glm_ivec3_mulsub(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] -= a[0] * b[0];
  dest[1] -= a[1] * b[1];
  dest[2] -= a[2] * b[2];
}
 ...
 */
CGLM_INLINE
void glm_ivec3_mulsubs(ivec3 a, int s, ivec3 dest) {
  dest[0] -= a[0] * s;
  dest[1] -= a[1] * s;
  dest[2] -= a[2] * s;
}
 ...
 */
CGLM_INLINE
void glm_ivec3_maxsub(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] -= glm_imax(a[0], b[0]);
  dest[1] -= glm_imax(a[1], b[1]);
  dest[2] -= glm_imax(a[2], b[2]);
}
 ...
 */
CGLM_INLINE
void glm_ivec3_minsub(ivec3 a, ivec3 b, ivec3 dest) {
  dest[0] -= glm_imin(a[0], b[0]);
  dest[1] -= glm_imin(a[1], b[1]);
  dest[2] -= glm_imin(a[2], b[2]);
}
 ...
 */
CGLM_INLINE
bool glm_ivec3_eqv(ivec3 a, ivec3 b) {
  return a[0] == b[0] && a[1] == b[1] && a[2] == b[2];
}

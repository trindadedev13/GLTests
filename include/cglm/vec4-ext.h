 ...
 */
CGLM_INLINE
void glm_vec4_floor(vec4 v, vec4 dest) {
  dest[0] = floorf(v[0]);
  dest[1] = floorf(v[1]);
  dest[2] = floorf(v[2]);
  dest[3] = floorf(v[3]);
 ...
 */
CGLM_INLINE
void glm_vec4_mods(vec4 v, float s, vec4 dest) {
  dest[0] = fmodf(v[0], s);
  dest[1] = fmodf(v[1], s);
  dest[2] = fmodf(v[2], s);
  dest[3] = fmodf(v[3], s);
 ...
 */
CGLM_INLINE
void glm_vec4_steps(float edge, vec4 x, vec4 dest) {
 ...
 */
CGLM_INLINE
void glm_vec4_stepr(vec4 edge, float x, vec4 dest) {

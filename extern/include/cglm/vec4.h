...
#elif defined(__SSE__) || defined(__SSE2__)
  glmm_store(dest,
             _mm_add_ps(glmm_load(dest), glmm_max(glmm_load(a), glmm_load(b))));
#elif defined(CGLM_NEON_FP)
  glmm_store(dest,
             vaddq_f32(glmm_load(dest), glmm_max(glmm_load(a), glmm_load(b))));
#else
...
#elif defined(__SSE__) || defined(__SSE2__)
  glmm_store(dest,
             _mm_add_ps(glmm_load(dest), glmm_min(glmm_load(a), glmm_load(b))));
#elif defined(CGLM_NEON_FP)
  glmm_store(dest,
             vaddq_f32(glmm_load(dest), glmm_min(glmm_load(a), glmm_load(b))));
#else
...
#elif defined(CGLM_NEON_FP)
  vst1q_f32(dest,
            vsubq_f32(vld1q_f32(dest), vsubq_f32(vld1q_f32(a), vld1q_f32(b))));
#else
  dest[0] -= a[0] - b[0];
  dest[1] -= a[1] - b[1];
  dest[2] -= a[2] - b[2];
...
#elif defined(CGLM_NEON_FP)
  vst1q_f32(dest,
            vsubq_f32(vld1q_f32(dest), vaddq_f32(vld1q_f32(a), vld1q_f32(b))));
#else
  dest[0] -= a[0] + b[0];
  dest[1] -= a[1] + b[1];
  dest[2] -= a[2] + b[2];
...
#elif defined(__SSE__) || defined(__SSE2__)
  glmm_store(dest,
             _mm_sub_ps(glmm_load(dest), glmm_max(glmm_load(a), glmm_load(b))));
#elif defined(CGLM_NEON_FP)
  glmm_store(dest,
             vsubq_f32(glmm_load(dest), glmm_max(glmm_load(a), glmm_load(b))));
#else
  dest[0] -= glm_max(a[0], b[0]);
  dest[1] -= glm_max(a[1], b[1]);
  dest[2] -= glm_max(a[2], b[2]);
...
#elif defined(__SSE__) || defined(__SSE2__)
  glmm_store(dest,
             _mm_sub_ps(glmm_load(dest), glmm_min(glmm_load(a), glmm_load(b))));
#elif defined(CGLM_NEON_FP)
  glmm_store(dest,
             vsubq_f32(vld1q_f32(dest), glmm_min(glmm_load(a), glmm_load(b))));
#else
  dest[0] -= glm_min(a[0], b[0]);
  dest[1] -= glm_min(a[1], b[1]);
  dest[2] -= glm_min(a[2], b[2]);

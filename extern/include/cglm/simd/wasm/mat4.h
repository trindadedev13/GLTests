...
CGLM_INLINE
void glm_mat4_scale_wasm(mat4 m, float s) {
  glmm_128 x0;
...
CGLM_INLINE
void glm_mat4_transp_wasm(mat4 m, mat4 dest) {
...
CGLM_INLINE
void glm_mat4_mul_wasm(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE
void glm_mat4_mulv_wasm(mat4 m, vec4 v, vec4 dest) {
...
CGLM_INLINE
float glm_mat4_det_wasm(mat4 mat) {
   ...
   */
  x0 = glmm_fnmadd(
      glmm_shuff1(r3, 0, 0, 1, 1), glmm_shuff1(r2, 2, 3, 2, 3),
      wasm_f32x4_mul(glmm_shuff1(r2, 0, 0, 1, 1), glmm_shuff1(r3, 2, 3, 2, 3)));
  /*
   t[0] = k * p - o * l;
   t[0] = k * p - o * l;
   t[5] = i * n - m * j;
   ...
   */
  x1 = glmm_fnmadd(
      glmm_shuff1(r3, 0, 0, 2, 2), glmm_shuff1(r2, 1, 1, 3, 3),
      wasm_f32x4_mul(glmm_shuff1(r2, 0, 0, 2, 2), glmm_shuff1(r3, 1, 1, 3, 3)));
  ...
  x2 = glmm_fmadd(glmm_shuff1(r1, 2, 3, 3, 3),
                  wasm_i32x4_shuffle(x0, x1, 1, 3, 6, 6), x2);
...
CGLM_INLINE
void glm_mat4_inv_fast_wasm(mat4 mat, mat4 dest) {
  glmm_128 r0, r1, r2, r3, v0, v1, v2, v3, t0, t1, t2, t3, t4, t5, x0, x1, x2,
...
CGLM_INLINE
void glm_mat4_inv_wasm(mat4 mat, mat4 dest) {
  glmm_128 r0, r1, r2, r3, v0, v1, v2, v3, t0, t1, t2, t3, t4, t5, x0, x1, x2,
      x3, x4, x5, x6, x7, x8, x9;
  ...
  x0 = wasm_f32x4_div(wasm_f32x4_splat(1.0f),
                      glmm_vhadd(wasm_f32x4_mul(x0, r0)));

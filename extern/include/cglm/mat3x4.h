 ...
 */
CGLM_INLINE
void glm_mat3x4_copy(mat3x4 src, mat3x4 dest) {
 ...
 */
CGLM_INLINE
void glm_mat3x4_make(const float* __restrict src, mat3x4 dest) {
  dest[0][0] = src[0];
  dest[0][1] = src[1];
  dest[0][2] = src[2];
  dest[0][3] = src[3];
 ...
 */
CGLM_INLINE
void glm_mat3x4_mul(mat3x4 m1, mat4x3 m2, mat4 dest) {
 ...
 */
CGLM_INLINE
void glm_mat3x4_mulv(mat3x4 m, vec3 v, vec4 dest) {
 ...
 */
CGLM_INLINE
void glm_mat3x4_transpose(mat3x4 src, mat4x3 dest) {
  dest[0][0] = src[0][0];
  dest[0][1] = src[1][0];
  dest[0][2] = src[2][0];
  dest[1][0] = src[0][1];
 ...
 */
CGLM_INLINE
void glm_mat3x4_scale(mat3x4 m, float s) {
  m[0][0] *= s;
  m[0][1] *= s;
  m[0][2] *= s;
  m[0][3] *= s;

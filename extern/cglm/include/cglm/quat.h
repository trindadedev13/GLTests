...
/*
 ...
 Functions:
   ...
   CGLM_INLINE void glm_quat_lerpc(versor from, versor to, float t, versor
 dest); CGLM_INLINE void glm_quat_slerp(versor q, versor r, float t, versor
 dest); CGLM_INLINE void glm_quat_slerp_longest(versor q, versor r, float t,
 versor dest); CGLM_INLINE void glm_quat_nlerp(versor q, versor r, float t,
 versor dest); CGLM_INLINE void glm_quat_look(vec3 eye, versor ori, mat4 dest);
...
/*!
 * @brief interpolates between two quaternions
 *        using spherical linear interpolation (SLERP) and always takes the long
 * path
 *
 * @param[in]   from  from
 * @param[in]   to    to
 ...
 */
CGLM_INLINE
void glm_quat_slerp_longest(versor from, versor to, float t, versor dest) {
  CGLM_ALIGN(16) vec4 q1, q2;
  float cosTheta, sinTheta, angle;

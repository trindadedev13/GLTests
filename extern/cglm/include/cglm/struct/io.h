...
/*
 Functions:
   ...
   CGLM_INLINE void glms_aabb_print(vec3s bbox[2], const char *tag, FILE
 *ostream);
 */
...
CGLM_INLINE
void glms_ivec4_print(ivec4s vec, FILE* __restrict ostream) {
...
CGLM_INLINE
void glms_vec2_print(vec2s vec, FILE* __restrict ostream) {
  glm_vec2_print(vec.raw, ostream);
}

CGLM_INLINE
void glms_ivec2_print(ivec2s vec, FILE* __restrict ostream) {

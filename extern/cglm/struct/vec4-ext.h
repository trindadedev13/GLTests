 ...
 */
CGLM_INLINE
bool glms_vec4_(eq)(vec4s v, float val) {
 ...
 */
CGLM_INLINE
bool glms_vec4_(eq_all)(vec4s v) {
 ...
 */
CGLM_INLINE
bool glms_vec4_(eqv)(vec4s a, vec4s b) {
 ...
 */
CGLM_INLINE
bool glms_vec4_(isvalid)(vec4s v) {

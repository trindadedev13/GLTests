 ...
 */
CGLM_INLINE
mat4s glms_frustum_lh_no(float left,
                         float right,
                         float bottom,
                         float top,
                         float nearZ,
 ...
 */
CGLM_INLINE
mat4s glms_perspective_lh_no(float fovy,
                             float aspect,
                             float nearZ,
                             float farZ) {
  mat4s dest;
 ...
 */
CGLM_INLINE
void glms_persp_decomp_lh_no(mat4s proj,
 ...
 */
CGLM_INLINE
void glms_persp_decomp_x_lh_no(mat4s proj,
                               float* __restrict left,
                               float* __restrict right) {
 ...
 */
CGLM_INLINE
void glms_persp_decomp_y_lh_no(mat4s proj,
                               float* __restrict top,
                               float* __restrict bottom) {
 ...
 */
CGLM_INLINE
void glms_persp_decomp_z_lh_no(mat4s proj,
                               float* __restrict nearZ,
                               float* __restrict farZ) {
